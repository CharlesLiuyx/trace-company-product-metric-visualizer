  ...
  return [
    {
      ...
      features: ['text', 'centered-side-label'],
    },
    {
    ...
    },
    {
      ...
      features: ['visible-interface', 'visible-short-node'],
    },
    {
      id: 'metric:revenue',
...
test('Income Statement plan compiles object features into mandatory rule checks', () => {
  ...
  assert.deepEqual(checks['feature:annotation-near-label'].ruleIds, ['B5', 'A6']);
  assert.deepEqual(checks['feature:visible-short-node'].ruleIds, ['T13', 'T14']);
