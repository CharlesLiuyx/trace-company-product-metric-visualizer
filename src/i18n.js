...
(function (global) {
  ...
  const UI = {
    en: {
      ...
      datasetReloadVersion: 'Reload the latest version',
      ...
      tableOperatingOtherIncome: 'Other operating income',
      tableOperatingOtherExpenses: 'Other operating expenses',
      tableOtherExpenses: 'Other expenses',
      tableProfitAdjustments: 'Profit adjustments',
      tableTax: 'Tax',
    ...
    zh: {
      ...
      datasetLoadRetry: '重试',
      datasetReloadVersion: '刷新以打开最新版本',
      ...
      tableOperatingOtherIncome: '营业利润调整收入',
      tableOperatingOtherExpenses: '营业利润调整支出',
      tableOtherExpenses: '其他支出',
      tableProfitAdjustments: '利润调整项目',
      tableTax: '税费',
      tableNetProfit: '净利润',
