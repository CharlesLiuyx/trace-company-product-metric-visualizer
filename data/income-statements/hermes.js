...
(function (global) {
  ...
  ssot.records.push(
    ...
    },
    {
      ...
      unit: 'B',
      decimals: 1,
      sourceImage: 'input/processed/hermes-h1-fy26.png',
      roundingTolerance: 0.16,
      revenue: {
        total: 8.2,
        notes: ['+2% Y/Y'],
        items: [
          { id: 'leather_goods_saddlery', label: 'Leather Goods & Saddlery', value: 3.8, notes: ['+5% Y/Y'] },
          { id: 'ready_to_wear_accessories', label: 'Ready-to-wear & Accessories', value: 2.2, notes: ['(3%) Y/Y'] },
          { id: 'silk_textiles', label: 'Silk & Textiles', value: 0.5, notes: ['+5% Y/Y'] },
          { id: 'other_hermes_sectors', label: 'Other Hermes sectors', value: 1.1, notes: ['+1% Y/Y'] },
          { id: 'perfume_beauty', label: 'Perfume & Beauty', value: 0.2, notes: ['(6%) Y/Y'] },
          { id: 'watches', label: 'Watches', value: 0.3, notes: ['(4%) Y/Y'] },
          { id: 'other_products', label: 'Other products', value: 0.2, notes: ['(0%) Y/Y'] },
        ],
      },
      costs: {
        costOfRevenue: { id: 'cost_of_sales', label: 'Cost of sales', value: 2.4 },
        operatingExpenses: {
          total: 2.5,
          items: [
            { id: 'sales_administrative', label: 'Sales & Administrative', value: 1.9, notes: ['23% of revenue'] },
            { id: 'other_opex', label: 'Other opex', value: 0.6, notes: ['7% of revenue'] },
          ],
        },
      ...
      profit: {
        gross: { id: 'gross_profit', label: 'Gross profit', value: 5.8, notes: ['71% of revenue', '+0pp Y/Y'] },
        operating: { id: 'operating_profit', label: 'Operating profit', value: 3.4, notes: ['41% of revenue', '(0pp) Y/Y'] },
        net: { id: 'net_profit', label: 'Net profit', value: 2.2, notes: ['28% of revenue', '(1pp) Y/Y'] },
      },
      i18n: {
        zh: {
          period: '2026 财年上半年',
          ...
          revenue: {
            notes: ['同比 +2%'],
            items: [
              { id: 'leather_goods_saddlery', label: '皮具与马具', notes: ['同比 +5%'] },
              { id: 'ready_to_wear_accessories', label: '成衣与配饰', notes: ['同比 (3%)'] },
              { id: 'silk_textiles', label: '丝绸与纺织品', notes: ['同比 +5%'] },
              { id: 'other_hermes_sectors', label: '其他爱马仕业务', notes: ['同比 +1%'] },
              { id: 'perfume_beauty', label: '香水与美妆', notes: ['同比 (6%)'] },
              { id: 'watches', label: '腕表', notes: ['同比 (4%)'] },
              { id: 'other_products', label: '其他产品', notes: ['同比 (0%)'] },
            ],
          },
          costs: {
            costOfRevenue: { label: '销售成本' },
          ...
          profit: {
            gross: { label: '毛利润', notes: ['占收入 71%', '同比 +0 个百分点'] },
            operating: { label: '营业利润', notes: ['占收入 41%', '同比 (0 个百分点)'] },
            net: { label: '净利润', notes: ['占收入 28%', '同比 (1 个百分点)'] },
          },
        },
      },
    }
