  ...
  ssot.records.push(
    ...
    },
    {
      ...
      revenue: {
        ...
        notes: ['(1%) Y/Y'],
        items: [
          { id: 'beverage', label: 'Beverage', value: 5.4, notes: ['(5%) Y/Y'] },
          { id: 'food', label: 'Food', value: 1.9, notes: ['+4% Y/Y'] },
          {
            id: 'other_revenue',
            label: 'Other',
            value: 2.0,
      ...
      costs: {
        costOfRevenue: {
          label: 'Cost of revenue',
          value: 7.0,
          notes: ['Source chart presents cost of revenue as Store opex ($4.2B) plus Product & distribution ($2.8B).'],
          items: [
            { id: 'store_opex', label: 'Store opex', value: 4.2 },
            { id: 'product_distribution', label: 'Product & distribution', value: 2.8 },
          ],
        },
        operatingExpenses: {
          total: 1.4,
      ...
      otherIncome: {
        total: 0.5,
        items: [{ id: 'gain', label: 'Gain', value: 0.5 }],
      },
      otherExpenses: {
        total: 0.1,
        items: [{ id: 'other_expense', label: 'Other', value: 0.1 }],
      ...
      profit: {
        gross: { id: 'gross_profit', label: 'Gross profit', value: 2.3, notes: ['25% margin', '+2pp Y/Y'] },
        operating: { id: 'operating_profit', label: 'Operating profit', value: 1.0, notes: ['11% margin', '+1pp Y/Y'] },
        net: { id: 'net_profit', label: 'Net profit', value: 1.0, notes: ['11% margin', '+5pp Y/Y'] },
      },
      i18n: {
        zh: {
          period: '2026 财年第三季度',
          ...
          revenue: {
            ...
            items: [
              { id: 'beverage', label: '饮品', notes: ['同比 (5%)'] },
              { id: 'food', label: '食品', notes: ['同比 +4%'] },
              { id: 'other_revenue', label: '其他', notes: ['同比 +5%', '包装饮品、版税和授权收入、原料'] },
            ],
          },
          costs: {
            costOfRevenue: {
              label: '收入成本',
              notes: ['来源图将收入成本列示为门店运营费用 ($4.2B) 加产品与分销 ($2.8B)。'],
              items: [
                { id: 'store_opex', label: '门店运营费用' },
                { id: 'product_distribution', label: '产品与分销' },
              ],
