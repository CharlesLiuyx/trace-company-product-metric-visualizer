...
(function (global) {
  ...
  ssot.records.push(
    ...
    },
    {
      ...
      unit: 'B',
      decimals: 1,
      sourceImage: 'input/processed/bank-of-america-q2-fy26.png',
      roundingTolerance: 0.2,
      revenue: {
        total: 31.6,
        notes: [
          '+15% Y/Y',
          'Business-segment revenue totals $32.4B before the $0.9B All Other noninterest loss; displayed figures are rounded.',
        ],
        items: [
          { id: 'consumer_banking', label: ['Consumer', 'Banking'], value: 11.3, notes: ['+5% Y/Y', '29% net margin'] },
          { id: 'global_wealth_investment_management', label: ['Global Wealth &', 'Investment Management'], value: 6.9, notes: ['+16% Y/Y', '21% net margin'] },
          { id: 'global_banking', label: 'Global Banking', value: 6.2, notes: ['+10% Y/Y', '33% net margin'] },
          { id: 'global_markets', label: 'Global Markets', value: 8.0, notes: ['+41% Y/Y', '33% net margin'] },
          { id: 'all_other', label: ['All Other', '(noninterest loss)'], value: -0.9 },
        ],
      },
      costs: {
        costOfRevenue: {
          ...
          label: 'Noninterest expenses',
          value: 18.6,
          notes: ['Expense detail totals $18.6B, matching the displayed noninterest-expenses total.'],
          items: [
            { id: 'compensation_benefits', label: 'Compensation & benefits', value: 11.0 },
            { id: 'information_processing', label: 'Information processing', value: 1.9 },
            { id: 'occupancy', label: 'Occupancy', value: 1.9 },
            { id: 'product_delivery', label: 'Product delivery', value: 1.3 },
            { id: 'professional_fees', label: 'Professional fees', value: 0.6 },
            { id: 'marketing', label: 'Marketing', value: 0.7 },
            { id: 'other_expenses', label: 'Other', value: 1.2 },
          ],
        },
        operatingExpenses: {
          total: 1.4,
          notes: ['Mapped to the operating-expenses schema slot for the source chart’s provision for credit losses.'],
          items: [{ id: 'operating_expenses', label: 'Provision for credit losses', value: 1.4 }],
        },
      ...
      profit: {
        ...
        operating: { id: 'pretax_income', label: 'Pretax income', value: 11.6 },
        net: { id: 'net_income', label: 'Net income', value: 9.1, notes: ['+27% Y/Y'] },
      },
      i18n: {
        zh: {
          period: '2026 财年第二季度',
          ...
          revenue: {
            notes: ['同比 +15%', '业务分部收入合计 $32.4B，扣除 $0.9B 的其他非利息亏损；图中数字经四舍五入。'],
            items: [
              { id: 'consumer_banking', label: '消费者银行', notes: ['同比 +5%', '净利率 29%'] },
              { id: 'global_wealth_investment_management', label: '全球财富与投资管理', notes: ['同比 +16%', '净利率 21%'] },
              { id: 'global_banking', label: '全球银行', notes: ['同比 +10%', '净利率 33%'] },
              { id: 'global_markets', label: '全球市场', notes: ['同比 +41%', '净利率 33%'] },
              { id: 'all_other', label: '其他（非利息亏损）' },
            ],
          },
          costs: {
            costOfRevenue: {
              label: '非利息费用',
              notes: ['费用明细合计为 $18.6B，与图示非利息费用总额一致。'],
              items: [
                { id: 'compensation_benefits', label: '薪酬与福利' },
                { id: 'information_processing', label: '信息处理' },
                { id: 'occupancy', label: '场地占用' },
