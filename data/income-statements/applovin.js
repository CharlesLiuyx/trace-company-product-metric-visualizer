/* Pure financial SSOT; geometry is in the View Adapter. */
(function(global){ const ssot=global.INCOME_STATEMENT_SSOT=global.INCOME_STATEMENT_SSOT||{schemaVersion:1,records:[]}; ssot.records.push(...[
  ...
  },
  {
    ...
    "unit": "M",
    "decimals": 0,
    "sourceImage": "input/processed/applovin-q2-fy26.png",
    "roundingTolerance": 1.1,
    "revenue": {
      "total": 1924,
      "notes": [
    ...
    "notes": [
      "Geographic values sum1923 vs1924; expense items203 vs204; operating1494 + other11 - tax239 =1266 vs net1267. Preserve rounded source amounts."
    ]
  }
]); })(window);
