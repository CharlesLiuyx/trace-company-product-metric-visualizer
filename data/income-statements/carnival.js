...
(function (global) {
  ...
  ssot.records.push({
    ...
    unit: 'B',
    decimals: 1,
    sourceImage: 'input/processed/carnival-q1-fy26.png',
    roundingTolerance: 0.15,
    revenue: {
      total: 6.2,
      notes: ['+6% Y/Y'],
      items: [
        { id: 'passenger_ticket', label: 'Passenger ticket', value: 4.0, notes: ['+5% Y/Y'] },
        { id: 'onboard_other_revenue', label: 'Onboard & other', value: 2.1, notes: ['+8% Y/Y'] },
      ],
    },
    costs: {
      costOfRevenue: {
        ...
        items: [
          {
            ...
            value: 3.9,
            children: [
              { id: 'commissions_transportation', label: 'Commissions & transportation', value: 0.9 },
              { id: 'onboard_other_cost', label: 'Onboard & other', value: 0.6 },
              { id: 'payroll_related', label: 'Payroll & related', value: 0.7 },
              { id: 'fuel', label: 'Fuel', value: 0.4 },
              { id: 'food', label: 'Food', value: 0.4 },
              { id: 'other_operating', label: 'Other operating', value: 1.0 },
            ],
          },
      ...
      tax: {
        label: 'Tax',
        value: 0,
        notes: ['The source does not show a separate tax flow; displayed operating profit less interest and other equals displayed net profit.'],
      },
    },
    ...
    profit: {
      gross: { label: 'Gross profit', value: 6.2, notes: ['Bookkeeping value only; the source does not show gross profit.'] },
      operating: { id: 'operating_profit', label: 'Operating profit', value: 0.6, notes: ['10% margin', '+1pp Y/Y'] },
      net: { id: 'net_profit', label: 'Net profit', value: 0.3, notes: ['4% margin', '+6pp Y/Y'] },
    },
    i18n: {
      zh: {
        period: '2026 财年第一季度',
        ...
        revenue: {
          notes: ['同比 +6%'],
          items: [
            { id: 'passenger_ticket', label: '乘客票务', notes: ['同比 +5%'] },
            { id: 'onboard_other_revenue', label: '船上及其他', notes: ['同比 +8%'] },
          ],
        },
        costs: {
          ...
          tax: { label: '税费', notes: ['来源图未单列税项；图示营业利润减去利息及其他后等于图示净利润。'] },
        },
