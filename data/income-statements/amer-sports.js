/* Pure financial SSOT; no view geometry. */
(function(global){ const ssot = global.INCOME_STATEMENT_SSOT = global.INCOME_STATEMENT_SSOT || {schemaVersion:1,records:[]}; ssot.records.push(...[
  ...
  },
  {
    ...
    "operatingOtherIncome": {
      "total": 4.2,
      "notes": [
        "Net of $5.1M other operating income and $0.9M impairment losses."
      ],
      "items": [
        {
          "id": "other",
          ...
          "value": 4.2,
          "notes": [
            "$4M in the rounded source chart"
          ]
        }
      ]
    },
    ...
    "i18n": {
      "zh": {
        ...
        "operatingOtherIncome": {
          "notes": [
            "净额包含 510 万美元其他营业收入及 90 万美元减值损失。"
          ],
          "items": [
            {
              "id": "other",
  ...
  },
  {
    ...
    "unit": "M",
    "decimals": 0,
    "sourceImage": "input/processed/amer-sports-q2-fy26.png",
    "roundingTolerance": 1.1,
    "revenue": {
      "total": 1633,
      "notes": [
        "+32% Y/Y",
        "Direct To Consumer 40%; Flat Y/Y"
      ],
      "items": [
        {
          "id": "technical_apparel",
