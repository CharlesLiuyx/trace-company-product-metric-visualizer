...
(function (global) {
  ...
  ssot.records.push(
    ...
    },
    {
      ...
      unit: 'B',
      decimals: 1,
      sourceImage: 'input/processed/asml-q2-fy26.png',
      roundingTolerance: 0.15,
      revenue: {
        total: 9.3,
        notes: ['+21% Y/Y'],
        items: [
          {
            ...
            notes: ['+17% Y/Y'],
            children: [
              { id: 'euv', label: 'EUV', value: 4.3, notes: ['Extreme Ultraviolet'] },
              { id: 'arfi', label: 'ArFi', value: 1.5, notes: ['Argon Fluoride immersion'] },
              { id: 'arf_dry', label: 'ArF Dry', value: 0.1, notes: ['Argon Fluoride Dry'] },
              { id: 'krf', label: 'KrF', value: 0.4, notes: ['Krypton Fluoride'] },
              { id: 'i_line', label: 'I-line', value: 0.1 },
              { id: 'metrology_inspection', label: 'Metrology & Inspection', value: 0.1 },
          ...
          { id: 'installed_base_management', label: 'Installed base management', value: 2.8, notes: ['+32% Y/Y'] },
        ],
      },
      costs: {
      ...
      otherExpenses: { total: 0, items: [] },
      profit: {
        gross: { id: 'gross_profit', label: 'Gross profit', value: 5.0, notes: ['54% margin', '+0pp Y/Y'] },
        operating: { id: 'operating_profit', label: 'Operating profit', value: 3.5, notes: ['37% margin', '+2pp Y/Y'] },
        net: { id: 'net_profit', label: 'Net profit', value: 2.9, notes: ['31% margin', '+2pp Y/Y'] },
      },
      i18n: {
        zh: {
          period: '2026 财年第二季度',
          ...
          revenue: {
            ...
            items: [
              {
                id: 'net_system_sales', label: '系统净销售额', notes: ['同比 +17%'],
                children: [
                  { id: 'euv', label: 'EUV', notes: ['极紫外'] },
                  { id: 'arfi', label: 'ArFi', notes: ['氟化氩浸没式'] },
                  { id: 'arf_dry', label: 'ArF Dry', notes: ['氟化氩干式'] },
              ...
              { id: 'installed_base_management', label: '装机基础管理', notes: ['同比 +32%'] },
            ],
          },
          costs: {
            costOfRevenue: { label: '销售成本' },
