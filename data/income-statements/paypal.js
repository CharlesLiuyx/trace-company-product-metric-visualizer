...
(function (global) {
  ...
  ssot.records.push(
    ...
    },
    {
        ...
        items: [
          {
            ...
            label: 'Transaction revenues',
            value: 7.8,
            notes: ['+5% Y/Y', 'Transaction fees for payments, currency conversion, cross-border payments, and transfers of funds'],
          },
          {
            id: 'other_value_added_services',
            label: 'Other value-added services',
            value: 0.9,
            notes: ['+0% Y/Y', 'Partnerships, referrals, subscriptions, gateway fees, and interest'],
          },
        ],
      },
      costs: {
        costOfRevenue: {
          ...
          value: 5.3,
          items: [
            { id: 'transaction_expense', label: 'Transaction expense', value: 4.4 },
            { id: 'transaction_credit_losses', label: 'Transaction & credit losses', value: 0.4 },
            { id: 'customer_support', label: 'Customer support', value: 0.5 },
          ],
        },
        operatingExpenses: {
          total: 2.0,
          items: [
            { id: 'technology_development', label: 'Technology & Development', value: 0.8, notes: ['10% of revenue', '+1pp Y/Y'] },
            { id: 'sales_marketing', label: 'S&M', value: 0.5, notes: ['6% of revenue', '(1pp) Y/Y'] },
            { id: 'general_administrative', label: 'G&A', value: 0.5, notes: ['6% of revenue', '+0pp Y/Y'] },
            { id: 'restructuring', label: 'Restructuring', value: 0.1, notes: ['1% of revenue', '(0pp) Y/Y'] },
          ],
        },
        tax: { id: 'tax', label: 'Tax', value: 0.2 },
      ...
      profit: {
        gross: { id: 'gross_profit', label: 'Gross profit', value: 3.4, notes: ['40% margin', '(2pp) Y/Y'] },
        operating: { id: 'operating_profit', label: 'Operating profit', value: 1.4, notes: ['16% margin', '(2pp) Y/Y'] },
        net: { id: 'net_profit', label: 'Net profit', value: 1.1, notes: ['13% margin', '(2pp) Y/Y'] },
      },
      i18n: {
        zh: {
          period: '2026 财年第二季度',
            ...
            items: [
              {
                id: 'transaction_revenues',
                label: '交易收入',
                notes: ['同比 +5%', '支付、货币兑换、跨境支付和资金转账的交易手续费'],
              },
              {
                id: 'other_value_added_services',
                label: '其他增值服务',
                notes: ['同比 +0%', '合作伙伴、推荐、订阅、网关费用和利息'],
              },
            ],
          },
          costs: {
            ...
            operatingExpenses: {
              items: [
                ...
                { id: 'sales_marketing', label: '销售与营销', notes: ['占收入 6%', '同比 (1 个百分点)'] },
                { id: 'general_administrative', label: '一般及行政费用', notes: ['占收入 6%', '同比 +0 个百分点'] },
                { id: 'restructuring', label: '重组', notes: ['占收入 1%', '同比 (0 个百分点)'] },
              ],
            },
            tax: { label: '税费' },
          ...
          profit: {
            gross: { label: '毛利润', notes: ['利润率 40%', '同比 (2 个百分点)'] },
            operating: { label: '营业利润', notes: ['利润率 16%', '同比 (2 个百分点)'] },
