...
(function (global) {
  ...
  ssot.records.push({
    ...
    unit: 'B',
    decimals: 1,
    sourceImage: 'input/processed/astrazeneca-q1-fy26.png',
    roundingTolerance: 0.25,
    revenue: {
      total: 15.3,
      notes: ['+13% Y/Y'],
      items: [
        { id: 'oncology', label: 'Oncology', value: 6.8, notes: ['+20% Y/Y'] },
        { id: 'cvrm', label: ['Cardiovascular,', 'Renal & Metabolism'], value: 3.3, notes: ['Flat Y/Y'] },
        { id: 'respiratory_immunology', label: ['Respiratory &', 'Immunology'], value: 2.3, notes: ['+11% Y/Y'] },
        { id: 'vaccines_immuno_oncology', label: ['Vaccines &', 'Immuno-Oncology'], value: 0.2, notes: ['(19%) Y/Y'] },
        { id: 'rare_disease', label: 'Rare Disease', value: 2.4, notes: ['+19% Y/Y'] },
        { id: 'other_medicines', label: 'Other medicines', value: 0.3, notes: ['+19% Y/Y'] },
      ],
    },
    costs: {
      ...
      operatingExpenses: {
        total: 8.6,
        items: [
          { id: 'sga', label: 'SG&A', value: 4.9, notes: ['32% of revenue', '(1pp) Y/Y'] },
          { id: 'rnd', label: 'R&D', value: 3.5, notes: ['23% of revenue', '(0pp) Y/Y'] },
          { id: 'opex_other', label: 'Other', value: 0.1, notes: ['1% of revenue', '(0pp) Y/Y'] },
        ],
      },
    ...
    profit: {
      gross: { id: 'gross_profit', label: 'Gross profit', value: 12.6, notes: ['82% margin', '(1pp) Y/Y'] },
      operating: { id: 'operating_profit', label: 'Operating profit', value: 4.2, notes: ['28% margin', '+1pp Y/Y'] },
      net: { id: 'net_profit', label: 'Net profit', value: 3.1, notes: ['20% margin', '(1%) Y/Y'] },
    },
    i18n: {
      zh: {
        period: '2026 财年第一季度', periodNote: '截至 2026 年 3 月',
        revenue: { notes: ['同比 +13%'], items: [
          { label: '肿瘤', notes: ['同比 +20%'] }, { label: ['心血管、肾脏', '与代谢'], notes: ['同比持平'] },
          { label: ['呼吸与', '免疫'], notes: ['同比 +11%'] }, { label: ['疫苗与', '免疫肿瘤'], notes: ['同比 (19%)'] },
          { label: '罕见病', notes: ['同比 +19%'] }, { label: '其他药品', notes: ['同比 +19%'] },
        ] },
        costs: { costOfRevenue: { label: '销售成本' }, operatingExpenses: { items: [
          { label: '销售、一般及行政费用', notes: ['占收入 32%', '同比 (1 个百分点)'] },
          { label: '研发', notes: ['占收入 23%', '同比 (0 个百分点)'] }, { label: '其他', notes: ['占收入 1%', '同比 (0 个百分点)'] },
        ] }, tax: { label: '税费' } },
        operatingOtherIncome: { items: [{ label: '其他' }] }, otherExpenses: { items: [{ label: '其他' }] },
        profit: { gross: { label: '毛利润', notes: ['利润率 82%', '同比 (1 个百分点)'] }, operating: { label: '营业利润', notes: ['利润率 28%', '同比 +1 个百分点'] }, net: { label: '净利润', notes: ['利润率 20%', '同比 (1%)'] } },
      },
    },
  });
})(window);
