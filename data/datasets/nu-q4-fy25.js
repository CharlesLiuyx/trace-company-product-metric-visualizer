...
(function () {
  ...
  window.DATASETS.push({
    ...
    layout: {
      nodes: {
        credit_card: { x: 368, y: 428, width: 71, height: 109 },
        lending: { x: 368, y: 664, width: 71, height: 113 },
        other_interest: { x: 368, y: 904, width: 71, height: 102 },
        interest_income: { x: 742, y: 553, width: 70, height: 331 },
        fee_commission_income: { x: 742, y: 1240, width: 70, height: 55 },
        revenue: { x: 1116, y: 644, width: 70, height: 386 },
        gross_profit: { x: 1489, y: 552, width: 71, height: 159 },
        interest_other: { x: 1489, y: 871, width: 71, height: 112 },
        credit_loss_allowance: { x: 1489, y: 1069, width: 71, height: 101 },
        transactional: { x: 1489, y: 1279, width: 71, height: 9 },
        pretax_income: { x: 1863, y: 465, width: 71, height: 86 },
        operating_expenses: { x: 1863, y: 715, width: 71, height: 70 },
        net_income: { x: 2236, y: 400, width: 71, height: 71 },
        tax: { x: 2236, y: 586, width: 71, height: 14 },
        ga: { x: 2236, y: 770, width: 71, height: 34 },
        customer_support: { x: 2236, y: 951, width: 71, height: 12 },
        marketing: { x: 2236, y: 1114, width: 71, height: 10 },
        other_expenses: { x: 2236, y: 1293, width: 71, height: 7 },
      },
    ...
    links: [
      { source: 'credit_card', target: 'interest_income', value: 1.3, width: 109, sourceWidth: 109, targetWidth: 109, y0: 482.5, y1: 607.5, sourceOrder: 0, targetOrder: 0 },
      { source: 'lending', target: 'interest_income', value: 1.4, width: 113, sourceWidth: 113, targetWidth: 113, y0: 720.5, y1: 720.5, sourceOrder: 0, targetOrder: 1 },
      { source: 'other_interest', target: 'interest_income', value: 1.3, width: 102, sourceWidth: 102, targetWidth: 103, y0: 955, y1: 832.5, sourceOrder: 0, targetOrder: 2 },
      { source: 'interest_income', target: 'revenue', value: 4.0, width: 331, sourceWidth: 331, targetWidth: 331, y0: 718.5, y1: 809.5, sourceOrder: 0, targetOrder: 0 },
      { source: 'fee_commission_income', target: 'revenue', value: 0.7, width: 55, sourceWidth: 55, targetWidth: 55, y0: 1267.5, y1: 1002.5, sourceOrder: 0, targetOrder: 1 },
      { source: 'revenue', target: 'gross_profit', value: 1.9, width: 159, sourceWidth: 159, targetWidth: 159, y0: 723.5, y1: 631.5, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'revenue', target: 'interest_other', value: 1.4, width: 112, sourceWidth: 112, targetWidth: 112, y0: 861, y1: 927, sourceOrder: 1, targetOrder: 0 },
      { source: 'revenue', target: 'credit_loss_allowance', value: 1.2, width: 101, sourceWidth: 101, targetWidth: 101, y0: 970.5, y1: 1119.5, sourceOrder: 2, targetOrder: 0 },
      { source: 'revenue', target: 'transactional', value: 0.1, width: 9, sourceWidth: 9, targetWidth: 9, y0: 1025.5, y1: 1283.5, sourceOrder: 3, targetOrder: 0 },
      { source: 'gross_profit', target: 'pretax_income', value: 1.1, width: 87, sourceWidth: 88, targetWidth: 86, y0: 596, y1: 508, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'gross_profit', target: 'operating_expenses', value: 0.9, width: 70, sourceWidth: 69, targetWidth: 70, y0: 676.5, y1: 750, sourceOrder: 1, targetOrder: 0 },
      { source: 'pretax_income', target: 'net_income', value: 0.9, width: 71, sourceWidth: 71, targetWidth: 71, y0: 500.5, y1: 435.5, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'pretax_income', target: 'tax', value: 0.2, width: 14, sourceWidth: 13, targetWidth: 14, y0: 544.5, y1: 593, sourceOrder: 1, targetOrder: 0 },
      { source: 'operating_expenses', target: 'ga', value: 0.4, width: 35, sourceWidth: 35, targetWidth: 34, y0: 732.5, y1: 787, sourceOrder: 0, targetOrder: 0 },
      { source: 'operating_expenses', target: 'customer_support', value: 0.2, width: 13, sourceWidth: 13, targetWidth: 12, y0: 758.5, y1: 957, sourceOrder: 1, targetOrder: 0 },
      { source: 'operating_expenses', target: 'marketing', value: 0.1, width: 10, sourceWidth: 10, targetWidth: 10, y0: 770, y1: 1119, sourceOrder: 2, targetOrder: 0 },
      { source: 'operating_expenses', target: 'other_expenses', value: 0.1, width: 10, sourceWidth: 10, targetWidth: 7, y0: 780, y1: 1296.5, sourceOrder: 3, targetOrder: 0 },
    ],
    i18n: {
      zh: {
        name: 'Nu · 2025 财年第四季度',
