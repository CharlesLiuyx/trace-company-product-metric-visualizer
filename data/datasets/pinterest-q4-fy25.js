...
(function () {
  ...
  window.DATASETS.push({
    ...
    links: [
      ...
      { source: 'europe', target: 'revenue', value: 245, width: 68, sourceWidth: 68, targetWidth: 67, y0: 882, y1: 881.5, sourceOrder: 0, targetOrder: 1 },
      { source: 'rest_of_world', target: 'revenue', value: 96, width: 26, sourceWidth: 26, targetWidth: 26, y0: 1067, y1: 928, sourceOrder: 0, targetOrder: 2 },
      { source: 'revenue', target: 'gross_profit', value: 1093, width: 298, sourceWidth: 298, targetWidth: 298, y0: 730, y1: 650, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'revenue', target: 'cost_of_revenue', value: 227, width: 62, sourceWidth: 62, targetWidth: 64, y0: 910, y1: 1036, sourceOrder: 1, targetOrder: 0 },
      { source: 'gross_profit', target: 'operating_profit', value: 301, width: 82, sourceWidth: 82, targetWidth: 82, y0: 542, y1: 454, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'gross_profit', target: 'operating_expenses', value: 791, width: 216, sourceWidth: 216, targetWidth: 216, y0: 691, y1: 788, sourceOrder: 1, targetOrder: 0 },
      { source: 'operating_profit', target: 'net_profit', value: 250, width: 69, sourceWidth: 69, targetWidth: 69, y0: 447.5, y1: 339.5, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'operating_profit', target: 'tax', value: 51, width: 13, sourceWidth: 13, targetWidth: 14, y0: 488.5, y1: 586, sourceOrder: 1, targetOrder: 0 },
      { source: 'other', target: 'net_profit', value: 27, width: 7, sourceWidth: 7, targetWidth: 7, y0: 435.5, y1: 377.5, sourceOrder: 0, targetOrder: 1, linkTint: GREEN_LINK },
      ...
      { source: 'operating_expenses', target: 'sm', value: 303, width: 83, sourceWidth: 83, targetWidth: 83, y0: 820.5, y1: 1009.5, sourceOrder: 1, targetOrder: 0 },
      { source: 'operating_expenses', target: 'ga', value: 123, width: 34, sourceWidth: 34, targetWidth: 34, y0: 879, y1: 1223, sourceOrder: 2, targetOrder: 0 },
    ],
    i18n: {
      zh: {
