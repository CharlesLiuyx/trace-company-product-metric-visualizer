...
(function () {
  ...
  window.DATASETS.push({
    ...
    links: [
      ...
      { source: 'console', target: 'platform_revenue', value: 0.6521, width: 87, sourceOrder: 0, targetOrder: 1, linkTint: BLUE_LINK },
      { source: 'pc_other', target: 'platform_revenue', value: 0.1811, width: 24, sourceOrder: 0, targetOrder: 2, linkTint: BLUE_LINK },
      { source: 'platform_revenue', target: 'game', value: 1.5703, width: 207, sourceOrder: 0, targetOrder: 0, linkTint: GRAY_LINK },
      { source: 'platform_revenue', target: 'advertising', value: 0.1287, width: 18, sourceOrder: 1, targetOrder: 0, linkTint: GRAY_LINK },
      { source: 'game', target: 'revenue', value: 1.5703, width: 207, sourceOrder: 0, targetOrder: 0, linkTint: GRAY_LINK },
      { source: 'advertising', target: 'revenue', value: 0.1287, width: 18, sourceOrder: 0, targetOrder: 1, linkTint: GRAY_LINK },
