/* ====================================================================
 * Sea - Q1 FY26 income statement ($B)
 * Reconstructed from input/processed/sea-q1-fy26.png as a fixed
...
(function () {
  ...
  const seaLogoSvg = `
    <defs>
      <clipPath id="sea-q1-fy26-logo-clip"><circle cx="95" cy="95" r="88"/></clipPath>
    </defs>
    <g clip-path="url(#sea-q1-fy26-logo-clip)">
  ...
  const annotations = (L) => `
    <g font-family="Montserrat,Arial,sans-serif">
      <path d="M1737 561 H1813" fill="none" stroke="${GREEN_LINK}" stroke-width="2.2" stroke-linecap="round"/>
      ...
      ${kpiCard(
        ...
        `
          ...
          <text x="764" y="1305" font-size="26" font-weight="500" fill="${WHITE}">$0.9B</text>
  ...
  const annotationsEn = annotations({
    ...
    shopeeMarketplaceYoy: '+61% Y/Y',
    garenaBookings: 'Garena Bookings',
    garenaBookingsYoy: '+20% Y/Y',
    other: 'Other',
  });
  ...
  const annotationsZh = annotations({
    ...
    shopeeMarketplaceYoy: '同比 +61%',
    garenaBookings: 'Garena 预订额',
    garenaBookingsYoy: '同比 +20%',
    other: '其他',
  });
  ...
  window.DATASETS.push({
    ...
    meta: {
      ...
      unit: 'B',
      decimals: 1,
      referenceImage: { src: 'input/processed/sea-q1-fy26.png', width: 2667, height: 1500 },
      titleX: 1334,
      titleY: 199,
      titleSize: 128,
      titleWeight: 800,
      titleTextLength: 1905,
      // The source carries this context only in its title, not as a separate stamp.
    ...
    layout: {
      nodes: {
        shopee: { x: 460, y: 474, width: 72, height: 244 },
        monee: { x: 460, y: 851, width: 72, height: 60 },
        garena: { x: 460, y: 1038, width: 72, height: 34 },
        other_services: { x: 460, y: 1200, width: 72, height: 4 },
        revenue: { x: 928, y: 662, width: 71, height: 337 },
        gross_profit: { x: 1394, y: 562, width: 73, height: 151 },
        cost_of_revenue: { x: 1394, y: 904, width: 73, height: 190 },
        other: { x: 1737, y: 560, width: 76, height: 2 },
        operating_profit: { x: 1862, y: 473, width: 71, height: 29 },
        operating_expenses: { x: 1861, y: 728, width: 73, height: 124 },
        sm: { x: 2328, y: 609, width: 73, height: 69 },
        ga: { x: 2329, y: 835, width: 72, height: 18 },
        rnd: { x: 2329, y: 1020, width: 72, height: 13 },
        credit_losses: { x: 2329, y: 1188, width: 72, height: 16 },
      },
      labels: {
        shopee: {
          blocks: [
            {
              x: 497, top: 381, anchor: 'middle', lineGap: 10,
              lines: [
        ...
        monee: {
          blocks: [
            {
              x: 497, top: 760, anchor: 'middle', lineGap: 10,
              lines: [
        ...
        other_services: {
          blocks: [
            {
              x: 497, top: 1144, anchor: 'middle', lineGap: 9,
              lines: [{ text: '$46M', size: 40, weight: 400, color: OTHER_GREY }],
            },
            {
              x: 260, top: 1179, anchor: 'middle',
        ...
        revenue: {
          blocks: [
            {
              x: 964, top: 520, anchor: 'middle', lineGap: 9,
              lines: [
        ...
        gross_profit: {
          blocks: [
            {
              x: 1430, top: 329, anchor: 'middle', lineGap: 8,
              lines: [
        ...
        cost_of_revenue: {
          blocks: [
            {
              x: 1430, top: 1104, anchor: 'middle', lineGap: 8,
              lines: [
        ...
        other: {
          blocks: [
            {
              x: 1775, top: 578, anchor: 'middle', lineGap: 8,
              lines: [
                { text: 'Other', size: 32, weight: 800 },
                { text: '$28M', size: 31, weight: 400 },
              ],
            },
          ],
        },
        operating_profit: {
          blocks: [
            {
              x: 1897, top: 238, anchor: 'middle', lineGap: 8,
              lines: [
        ...
        operating_expenses: {
          blocks: [
            {
              x: 1897, top: 871, anchor: 'middle', lineGap: 8,
              lines: [
                { text: 'Operating', size: 37, weight: 800 },
        ...
        sm: {
          blocks: [
            {
              x: 2505, top: 614, anchor: 'middle', lineGap: 8,
              lines: [
        ...
        ga: {
          blocks: [
            {
              x: 2505, top: 802, anchor: 'middle', lineGap: 8,
              lines: [
        ...
        rnd: {
          blocks: [
            {
              x: 2505, top: 987, anchor: 'middle', lineGap: 8,
              lines: [
        ...
        credit_losses: {
          blocks: [
            {
              x: 2520, top: 1168, anchor: 'middle', lineGap: 8,
              lines: [
    ...
    nodes: [
      { id: 'shopee', col: 0, order: 0, type: 'source', label: 'Shopee', value: 5.1, notes: ['+45% Y/Y', 'E-commerce'], color: BLUE, labelColor: SHOPEE, linkTint: BLUE_LINK },
      { id: 'monee', col: 0, order: 1, type: 'source', label: 'Monee', value: 1.2, notes: ['+58% Y/Y', 'Digital Financial Services'], color: BLUE, labelColor: MONEE, linkTint: BLUE_LINK },
      { id: 'garena', col: 0, order: 2, type: 'source', label: 'Garena', value: 0.7, notes: ['+41% Y/Y', 'Digital Entertainment'], color: BLUE, labelColor: GARENA, linkTint: BLUE_LINK },
      { id: 'other_services', col: 0, order: 3, type: 'source', label: 'Other Services', value: 0.046, valueText: '$46M', color: BLUE, labelColor: OTHER_GREY, linkTint: BLUE_LINK },
      { id: 'revenue', col: 1, order: 0, type: 'hub', label: 'Revenue', value: 7.1, notes: ['+47% Y/Y'], color: BLUE, labelColor: BLUE_LABEL },
      { id: 'gross_profit', col: 2, order: 0, type: 'profit', label: 'Gross profit', value: 3.1, notes: ['44% margin', '(2pp) Y/Y'], color: GREEN, labelColor: GREEN_LABEL, linkTint: GREEN_LINK },
      { id: 'cost_of_revenue', col: 2, order: 1, type: 'cost', label: ['Cost of', 'revenue'], value: 4.0, color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'other', col: 3, order: 0, type: 'profit', label: 'Other', value: 0.028, valueText: '$28M', color: BG, labelColor: GREEN_LABEL, linkTint: GREEN_LINK },
      { id: 'operating_profit', col: 4, order: 0, type: 'profit', label: ['Operating', 'profit'], value: 0.6, notes: ['8% margin', '(1pp) Y/Y'], color: GREEN, labelColor: GREEN_LABEL, linkTint: GREEN_LINK },
      { id: 'operating_expenses', col: 4, order: 1, type: 'cost', label: ['Operating', 'expenses'], value: 2.6, color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      ...
      { id: 'ga', col: 5, order: 1, type: 'cost', label: 'G&A', value: 0.4, notes: ['6% of revenue', '(1pp) Y/Y'], color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      ...
      { id: 'credit_losses', col: 5, order: 3, type: 'cost', label: ['Provision for', 'credit losses'], value: 0.5, notes: ['7% of revenue', '+1pp Y/Y'], color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
    ],

    links: [
      { source: 'shopee', target: 'revenue', value: 5.1, width: 244, sourceOrder: 0, targetOrder: 0 },
      {
        source: 'monee', target: 'revenue', value: 1.2,
        sourceWidth: 60, targetWidth: 55, sourceOrder: 0, targetOrder: 1,
      },
      { source: 'garena', target: 'revenue', value: 0.7, width: 34, sourceOrder: 0, targetOrder: 2 },
      { source: 'other_services', target: 'revenue', value: 0.046, width: 4, sourceOrder: 0, targetOrder: 3 },

      { source: 'revenue', target: 'gross_profit', value: 3.1, width: 151, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      {
        source: 'revenue', target: 'cost_of_revenue', value: 4.0,
        sourceWidth: 186, targetWidth: 190, sourceOrder: 1, targetOrder: 0, linkTint: RED_LINK,
      },

      { source: 'gross_profit', target: 'operating_profit', value: 0.6, width: 26, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'gross_profit', target: 'operating_expenses', value: 2.6, width: 124, sourceOrder: 1, targetOrder: 0, linkTint: RED_LINK },
      {
        source: 'other', target: 'operating_profit', value: 0.028, width: 2,
        sourceOrder: 0, targetOrder: 1, linkTint: GREEN_LINK,
        y0: 561, y1: 501,
        curve: { x0: 1813, x1: 1862, c1x: 1830, c2x: 1847, c1y: 561, c2y: 501 },
      },
      ...
      {
        source: 'operating_expenses', target: 'credit_losses', value: 0.5,
        sourceWidth: 24, targetWidth: 16, sourceOrder: 3, targetOrder: 0,
      },
    ],
    ...
    i18n: {
      ...
      zh: {
        ...
        nodes: {
          shopee: { label: 'Shopee 电商', notes: ['同比 +45%', '电商'] },
          monee: { label: 'Monee 金融服务', notes: ['同比 +58%', '数字金融服务'] },
          garena: { label: 'Garena 游戏娱乐', notes: ['同比 +41%', '数字娱乐'] },
          other_services: { label: '其他服务' },
          revenue: { label: '收入', notes: ['同比 +47%'] },
          gross_profit: { label: '毛利润', notes: ['毛利率 44%', '同比 (2 个百分点)'] },
          cost_of_revenue: { label: ['收入', '成本'] },
          other: { label: '其他' },
          operating_profit: { label: ['营业', '利润'], notes: ['利润率 8%', '同比 (1 个百分点)'] },
          operating_expenses: { label: ['营业', '费用'] },
          sm: { label: '销售与营销', notes: ['占收入 20%', '同比 +1 个百分点'] },
          ga: { label: '一般及行政', notes: ['占收入 6%', '同比 (1 个百分点)'] },
          rnd: { label: '研发', notes: ['占收入 4%', '同比 (2 个百分点)'] },
          credit_losses: { label: ['信用', '损失拨备'], notes: ['占收入 7%', '同比 +1 个百分点'] },
        },
        layout: {
          labels: {
            shopee: {
              blocks: [
                {
                  ...
                  lines: [
                    { text: '$value', size: 36, weight: 400, color: SHOPEE },
                    { text: '同比 +45%', size: 27, weight: 400, color: NOTE },
                  ],
                },
              ],
            },
            ...
            credit_losses: {
              blocks: [
                {
                  x: 2535, top: 1168, anchor: 'middle', lineGap: 8,
                  lines: [
