...
(function () {
  ...
  const annotationsZh = `
    <g font-family="Montserrat,Arial,sans-serif">
      ...
      ${kpiCard(36, 276, ['调整后美国', '可比销售额', '同比 +6.8%'], "Montserrat,Arial,'Microsoft YaHei',sans-serif")}
      ${kpiCard(320, 330, ['调整后公司', '可比销售额', '同比 +6.6%'], "Montserrat,Arial,'Microsoft YaHei',sans-serif")}
      ${kpiCard(660, 276, ['调整后', '数字化可比销售额', '同比 +20.8%'], "Montserrat,Arial,'Microsoft YaHei',sans-serif")}
    </g>`;
