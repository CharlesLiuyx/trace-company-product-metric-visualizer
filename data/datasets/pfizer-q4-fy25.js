...
(function () {
  ...
  const zhLayoutLabels = {
    ...
    operating_loss: { blocks: [{ x: 1796, top: 1098, anchor: 'middle', lineGap: 6, lines: [{ text: '营业', size: 39, weight: 800 }, { text: '亏损', size: 39, weight: 800 }, { text: '$value', size: 39, weight: 400 }, { text: '利润率 (9%)', size: 28, weight: 400, color: NOTE }, { text: '同比 (9 个百分点)', size: 28, weight: 400, color: NOTE }] }] },
    ...
    i18n: {
      zh: {
        ...
        nodes: {
          ...
          biopharma: { label: '生物制药', notes: ['同比 (2%)'] }, revenue: { label: '收入', notes: ['同比 (1%)'] }, gross_profit: { label: '毛利润', notes: ['利润率 70%', '同比 +3 个百分点'] }, cost_of_sales: { label: '销售成本' }, operating_loss: { label: ['营业', '亏损'], notes: ['利润率 (9%)', '同比 (9 个百分点)'] }, operating_expenses: { label: '营业费用' },
