...
(function () {
  ...
  const annotationsZh = `
    <g transform="scale(0.569142)" font-family="Montserrat,Arial,sans-serif">
      ${statsCard(35, 667, '数字订阅用户', '11.8M', '同比 +12%', 330, 150, 'Noto Sans SC,Noto Sans,Arial,sans-serif')}
      ${statsCard(722, 535, '数字业务 ARPU', '$9.79', '同比 +4%', 300, 140, 'Noto Sans SC,Noto Sans,Arial,sans-serif')}
