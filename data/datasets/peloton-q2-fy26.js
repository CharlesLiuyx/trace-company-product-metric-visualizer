  ...
  const annotations = (isZh) => `
    <g font-family="Montserrat,Arial,sans-serif">
      ...
      <g>
        ...
        ${isZh
          ? '<text x="531.5" y="1236" text-anchor="middle" font-size="27" font-weight="500" fill="#ffffff">订阅 2.7M（同比 (7%)）</text><text x="531.5" y="1280" text-anchor="middle" font-size="25" font-weight="500" fill="#ffffff">App 订阅 0.5M（同比 (11%)）</text>'
