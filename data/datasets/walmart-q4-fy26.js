...
(function () {
  ...
  const annotationsZh = `
    <g font-family="Montserrat,Arial,sans-serif">
      ${icon('walmartCompanyWordmark', 602, 276, 1)}
      ${icon('samsClubWordmark', 95, 1248, 1)}
      ${kpiCard(1866, 310, ['美国可比销售额', '同比 +4.6%'], "Montserrat,Arial,'Microsoft YaHei',sans-serif")}
      ${kpiCard(2187, 355, ['电商同比 +24%', '广告同比 +37%'], "Montserrat,Arial,'Microsoft YaHei',sans-serif")}
    </g>`;
