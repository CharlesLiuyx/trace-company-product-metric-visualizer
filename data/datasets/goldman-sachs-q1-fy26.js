...
(function () {
  ...
  window.DATASETS.push({
    ...
    links: [
      ...
      { source: 'revenue', target: 'pretax_income', value: 6.5, sourceOrder: 0, targetOrder: 0 },
      { source: 'revenue', target: 'operating_expenses', value: 10.4, sourceOrder: 1, targetOrder: 0 },
      { source: 'revenue', target: 'provision_for_credit_loss', value: 0.3, sourceOrder: 2, targetOrder: 0 },
      ...
      { source: 'operating_expenses', target: 'market_development', value: 0.2, sourceOrder: 2, targetOrder: 0, targetWidth: 2 },
      ...
      { source: 'operating_expenses', target: 'professional_fees', value: 0.4, sourceOrder: 6, targetOrder: 0, targetWidth: 2 },
      { source: 'operating_expenses', target: 'other', value: 0.6, sourceOrder: 7, targetOrder: 0, sourceWidth: 8.125 },
    ],
    layout: {
      scale: 16.25,
      nodes: {
        ...
        market_development: { x: 2266, y: 752, width: 74, height: 2 },
        ...
        professional_fees: { x: 2266, y: 1193, width: 74, height: 2 },
