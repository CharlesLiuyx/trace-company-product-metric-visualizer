...
(function () {
  ...
  function mkLabels(T, inlineTerminals) {
    ...
    const L = {
      ...
      other_ded: {
        blocks: [
          { x: 2421, top: 729, anchor: 'middle', lineGap: 8, lines: [...nameL(T.other_ded, 31, RED_LABEL), { text: '($0.06B)', size: 31, weight: 400, color: RED_LABEL }] },
        ],
      },
    };
  ...
  window.DATASETS.push({
    ...
    render: {
      ...
      // Keep the minimum-visible $0.060B terminal's complete 6px node face
      // as the fidelity target rather than inheriting a sub-pixel reference.
    ...
    layout: {
      ...
      nodes: {
        ...
        // The SEC-reported $0.060B net non-operating expense needs a
        // minimum-visible terminal face at this fixed chart scale.
        other_ded: { x: 2232, y: 751, width: 72, height: 6 },
    ...
    nodes: [
      { id: 'service', col: 0, order: 0, type: 'source', label: 'Service', value: 4.981, valueText: '$5.0B', notes: ['+13% Y/Y'], color: NAVY, labelColor: NAVY, linkTint: NAVY_LINK },
      { id: 'data_processing', col: 0, order: 1, type: 'source', label: ['Data', 'processing'], value: 5.543, notes: ['+18% Y/Y'], color: NAVY, labelColor: NAVY, linkTint: NAVY_LINK },
      { id: 'international', col: 0, order: 2, type: 'source', label: ['International', 'transaction'], value: 3.631, notes: ['+10% Y/Y'], color: NAVY, labelColor: NAVY, linkTint: NAVY_LINK },
      { id: 'other_rev', col: 0, order: 3, type: 'source', label: 'Other', value: 1.320, notes: ['+41% Y/Y'], color: NAVY, labelColor: NAVY, linkTint: NAVY_LINK },
      { id: 'revenue', col: 1, order: 0, type: 'hub', label: '', value: 15.475, color: NAVY, labelColor: NAVY, linkTint: NAVY_LINK },
      { id: 'net_revenue', col: 2, order: 0, type: 'hub', label: 'Net revenue', value: 11.230, valueText: '$11.2B', notes: ['+17% Y/Y'], color: NAVY, labelColor: NAVY, linkTint: NAVY_LINK },
      { id: 'client_incentives', col: 2, order: 1, type: 'cost', label: ['Client', 'incentives'], value: 4.245, valueText: '($4.2B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'operating_profit', col: 3, order: 0, type: 'profit', label: 'Operating profit', value: 7.234, valueText: '$7.2B', notes: ['64% margin', '+8pp Y/Y'], color: GREEN, labelColor: GREEN_LABEL, linkTint: GREEN_LINK },
      { id: 'operating_expenses', col: 3, order: 1, type: 'cost', label: ['Operating', 'expenses'], value: 3.996, valueText: '($3.7B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'net_profit', col: 4, order: 0, type: 'profit', label: 'Net profit', value: 6.021, valueText: '$6.0B', notes: ['54% margin', '+6pp Y/Y'], color: GREEN, labelColor: GREEN_LABEL, linkTint: GREEN_LINK },
      { id: 'tax', col: 4, order: 1, type: 'cost', label: 'Tax', value: 1.153, valueText: '($0.9B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'other_ded', col: 4, order: 2, type: 'cost', label: 'Other', value: 0.060, valueText: '($0.06B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'personnel', col: 5, order: 0, type: 'cost', label: 'Personnel', value: 1.841, valueText: '($1.8B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'marketing', col: 5, order: 1, type: 'cost', label: 'Marketing', value: 0.545, valueText: '($0.5B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'general_admin', col: 5, order: 2, type: 'cost', label: 'General & admin', value: 0.450, valueText: '($0.5B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'da', col: 5, order: 3, type: 'cost', label: 'D&A', value: 0.333, valueText: '($0.3B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'litigation', col: 5, order: 4, type: 'cost', label: 'Litigation', value: 0.329, valueText: '($0.3B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'network', col: 5, order: 5, type: 'cost', label: 'Network', value: 0.260, valueText: '($0.3B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'professional_fees', col: 5, order: 6, type: 'cost', label: 'Professional fees', value: 0.238, valueText: '($0.2B)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
    ],

    links: [
      { source: 'service', target: 'revenue', value: 4.981, width: 116, sourceOrder: 0, targetOrder: 0 },
      { source: 'data_processing', target: 'revenue', value: 5.543, sourceWidth: 130, targetWidth: 132, sourceOrder: 0, targetOrder: 1 },
      { source: 'international', target: 'revenue', value: 3.631, width: 85, sourceOrder: 0, targetOrder: 2 },
      { source: 'other_rev', target: 'revenue', value: 1.320, width: 30, sourceOrder: 0, targetOrder: 3 },
      { source: 'revenue', target: 'net_revenue', value: 11.230, width: 264, sourceOrder: 0, targetOrder: 0, linkTint: NAVY_LINK },
      { source: 'revenue', target: 'client_incentives', value: 4.245, width: 99, sourceOrder: 1, targetOrder: 0 },
      { source: 'net_revenue', target: 'operating_profit', value: 7.234, width: 170, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'net_revenue', target: 'operating_expenses', value: 3.996, width: 93, sourceOrder: 1, targetOrder: 0 },
      { source: 'operating_profit', target: 'net_profit', value: 6.021, sourceWidth: 138, targetWidth: 142, sourceOrder: 0, targetOrder: 0 },
      { source: 'operating_profit', target: 'tax', value: 1.153, sourceWidth: 26, targetWidth: 26, sourceOrder: 1, targetOrder: 0 },
      { source: 'operating_profit', target: 'other_ded', value: 0.060, sourceWidth: 6, targetWidth: 6, sourceOrder: 2, targetOrder: 0 },
      // Preserve the source image's continuous 93px Opex parent face while
      // retaining the individually measured terminal widths at the right.
      { source: 'operating_expenses', target: 'personnel', value: 1.841, sourceWidth: 43, targetWidth: 42, sourceOrder: 0, targetOrder: 0 },
      { source: 'operating_expenses', target: 'marketing', value: 0.545, sourceWidth: 13, targetWidth: 12, sourceOrder: 1, targetOrder: 0 },
      { source: 'operating_expenses', target: 'general_admin', value: 0.450, sourceWidth: 11, targetWidth: 10, sourceOrder: 2, targetOrder: 0 },
      { source: 'operating_expenses', target: 'da', value: 0.333, sourceWidth: 8, targetWidth: 7, sourceOrder: 3, targetOrder: 0 },
      { source: 'operating_expenses', target: 'litigation', value: 0.329, sourceWidth: 7, targetWidth: 6, sourceOrder: 4, targetOrder: 0 },
      { source: 'operating_expenses', target: 'network', value: 0.260, sourceWidth: 5, targetWidth: 4, sourceOrder: 5, targetOrder: 0 },
      { source: 'operating_expenses', target: 'professional_fees', value: 0.238, sourceWidth: 6, targetWidth: 6, sourceOrder: 6, targetOrder: 0 },
    ],
