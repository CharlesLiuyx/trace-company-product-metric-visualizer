...
(function () {
  ...
  window.DATASETS.push({
    ...
    links: [
      ...
      // The source-sized green ribbon carries operating profit after the $0.6B tax branch: $2.5B - $0.6B = $1.9B. Geometry remains reference-measured; value drives financial and hover semantics.
      { source: 'operating_profit', target: 'net_profit', value: 1.9, sourceWidth: 54, targetWidth: 55, y0: 497, y1: 387.5, linkTint: GREEN_LINK, hoverPercentMode: 'contribution' }, { source: 'operating_profit', target: 'tax', value: 0.6, sourceWidth: 17, targetWidth: 17, y0: 532.5, y1: 625.5, linkTint: RED_LINK }, { source: 'other_income', target: 'net_profit', value: 0.6, sourceWidth: 15, targetWidth: 15, y0: 464.5, y1: 422.5, linkTint: GREEN_LINK, hoverPercentMode: 'contribution' },
