/* ====================================================================
 * CrowdStrike - Q1 FY27 income statement ($M)
 * Reconstructed from input/processed/crowdstrike-q1-fy27.png as a fixed
...
(function () {
  ...
  const annotationsEn = `
    <g font-family="Montserrat,Arial,sans-serif">
      ${card(30, 1143, 146, 162, ['ARR', '$5.51B', '+24% Y/Y'])}
  ...
  const annotationsZh = `
    <g font-family="Montserrat,Arial,sans-serif">
      ${card(30, 1143, 146, 162, ['ARR', '$5.51B', '同比 +24%'])}
  ...
  const zhLayoutLabels = {
    subscription: {
      blocks: [
        {
          x: 427, top: 424, anchor: 'middle', lineGap: 13,
          lines: [
    ...
    gross_profit: {
      blocks: [
        {
          x: 1361, top: 345, anchor: 'middle', lineGap: 13,
          lines: [
    ...
    operating_loss: {
      blocks: [
        {
          x: 1622, top: 1052, anchor: 'middle', lineGap: 13,
          lines: [
            { text: '营业', size: 40, weight: 800, color: RED_LABEL },
      ...
      blocks: [
        {
          ...
          lines: [
            ...
            { text: '占收入 35%', size: 28, weight: 400, color: NOTE },
  ...
  window.DATASETS.push({
    ...
    meta: {
      ...
      unit: 'M',
      decimals: 0,
      referenceImage: { src: 'input/processed/crowdstrike-q1-fy27.png', width: 2667, height: 1500 },
      titleX: 1334,
      titleY: 205,
      titleSize: 118,
      titleWeight: 800,
    ...
    layout: {
      scale: 0.2706,
      nodes: {
        subscription: { x: 391, y: 525, width: 72, height: 358 },
        professional_services: { x: 391, y: 1053, width: 72, height: 17 },
        revenue: { x: 859, y: 619, width: 71, height: 375 },
        gross_profit: { x: 1326, y: 535, width: 71, height: 282 },
        cost_of_revenue: { x: 1326, y: 986, width: 71, height: 93 },
        operating_expenses: { x: 1793, y: 621, width: 72, height: 291 },
        operating_loss: { x: 1583, y: 1035, width: 72, height: 9 },
        sm: { x: 2260, y: 453, width: 72, height: 133 },
        rnd: { x: 2260, y: 752, width: 72, height: 110 },
        ga: { x: 2260, y: 1036, width: 72, height: 48 },
      },
      labels: {
        subscription: {
          blocks: [
          ...
          blocks: [
            {
              ...
              lines: [
                ...
                { text: '35% of revenue', size: 27, weight: 400, color: NOTE },
          ...
          blocks: [
            {
              ...
              lines: [
                ...
                { text: '$value', size: 31, weight: 400 },
                { text: '29% of revenue', size: 27, weight: 400, color: NOTE },
    ...
    nodes: [
      { id: 'subscription', col: 0, order: 0, type: 'source', label: 'Subscription', value: 1321, valueText: '$1,321M', notes: ['+26% Y/Y'], color: BLACK, labelColor: BLACK, linkTint: GRAY_LINK },
      { id: 'professional_services', col: 0, order: 1, type: 'source', label: ['Professional', 'services'], value: 65, notes: ['+23% Y/Y'], color: BLACK, labelColor: BLACK, linkTint: GRAY_LINK },
      { id: 'revenue', col: 1, order: 0, type: 'hub', label: 'Revenue', value: 1386, valueText: '$1,386M', notes: ['+26% Y/Y'], color: BLACK, labelColor: BLACK, linkTint: GRAY_LINK },
      { id: 'gross_profit', col: 2, order: 0, type: 'profit', label: 'Gross profit', value: 1043, valueText: '$1,043M', notes: ['75% margin', '+2pp Y/Y'], color: GREEN, labelColor: GREEN_LABEL, linkTint: GREEN_LINK },
      { id: 'cost_of_revenue', col: 2, order: 1, type: 'cost', label: ['Cost of', 'revenue'], value: 342, color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'operating_loss', col: 3, order: 1, type: 'cost', label: ['Operating', 'loss'], value: -31, notes: ['(2%) margin', '+9pp Y/Y'], color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'operating_expenses', col: 4, order: 0, type: 'cost', label: ['Operating', 'expenses'], value: 1074, valueText: '($1,074M)', color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'sm', col: 5, order: 0, type: 'cost', label: 'S&M', value: 489, notes: ['35% of revenue', '(5pp) Y/Y'], color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'rnd', col: 5, order: 1, type: 'cost', label: 'R&D', value: 408, notes: ['29% of revenue', '(1pp) Y/Y'], color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
      { id: 'ga', col: 5, order: 2, type: 'cost', label: 'G&A', value: 177, notes: ['13% of revenue', '(2pp) Y/Y'], color: RED, labelColor: RED_LABEL, linkTint: RED_LINK },
    ],

    links: [
      { source: 'subscription', target: 'revenue', value: 1321, width: 358, sourceOrder: 0, targetOrder: 0 },
      { source: 'professional_services', target: 'revenue', value: 65, width: 17, sourceOrder: 0, targetOrder: 1 },
      { source: 'revenue', target: 'gross_profit', value: 1043, width: 282, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'revenue', target: 'cost_of_revenue', value: 342, width: 93, sourceOrder: 1, targetOrder: 0 },
      { source: 'gross_profit', target: 'operating_expenses', value: 1043, width: 282, sourceOrder: 0, targetOrder: 0 },
      { source: 'operating_loss', target: 'operating_expenses', value: 31, width: 9, sourceOrder: 0, targetOrder: 1 },
      { source: 'operating_expenses', target: 'sm', value: 489, width: 133, sourceOrder: 0, targetOrder: 0 },
      { source: 'operating_expenses', target: 'rnd', value: 408, width: 110, sourceOrder: 1, targetOrder: 0 },
      { source: 'operating_expenses', target: 'ga', value: 177, width: 48, sourceOrder: 2, targetOrder: 0 },
    ],
    ...
    i18n: {
      ...
      zh: {
        ...
        nodes: {
          subscription: { label: '订阅', notes: ['同比 +26%'] },
          professional_services: { label: ['专业', '服务'], notes: ['同比 +23%'] },
          revenue: { label: '收入', notes: ['同比 +26%'] },
          gross_profit: { label: '毛利润', notes: ['利润率 75%', '同比 +2 个百分点'] },
          cost_of_revenue: { label: ['收入', '成本'] },
          operating_loss: { label: ['营业', '亏损'], notes: ['利润率 (2%)', '同比 +9 个百分点'] },
          operating_expenses: { label: ['营业', '费用'] },
          sm: { label: '销售与市场', notes: ['占收入 35%', '同比 (5 个百分点)'] },
          rnd: { label: '研发', notes: ['占收入 29%', '同比 (1 个百分点)'] },
          ga: { label: '管理费用', notes: ['占收入 13%', '同比 (2 个百分点)'] },
        },
