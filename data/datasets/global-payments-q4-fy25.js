...
(function () {
  ...
  window.DATASETS.push({
    ...
    links: [
      ...
      { source: 'revenue', target: 'operating_expenses', value: 1.681435, width: 297, sourceWidth: 296, targetWidth: 298, y0: 866, y1: 968, sourceOrder: 1, targetOrder: 0, linkTint: RED_LINK },
      { source: 'operating_profit', target: 'net_profit', value: 0.070922, width: 11, sourceWidth: 11, targetWidth: 11, y0: 539.5, y1: 419.5, sourceOrder: 0, targetOrder: 1, linkTint: GREEN_LINK },
      { source: 'operating_profit', target: 'interest', value: 0.144408, width: 23, sourceWidth: 22, targetWidth: 24, y0: 559, y1: 707, sourceOrder: 1, targetOrder: 0, linkTint: RED_LINK },
      ...
      { source: 'other', target: 'net_profit', value: 0.113977, width: 21, sourceWidth: 21, targetWidth: 21, y0: 512.5, y1: 438.5, sourceOrder: 0, targetOrder: 2, linkTint: GREEN_LINK },
      ...
      { source: 'operating_expenses', target: 'cost_of_service', value: 0.557343, width: 97.5, sourceWidth: 97, targetWidth: 98, y0: 1062.5, y1: 1171, sourceOrder: 1, targetOrder: 0, linkTint: RED_LINK },
