...
(function () {
  ...
  window.DATASETS.push({
    ...
    links: [
      { source: 'merchants_solutions', target: 'revenue', value: 1.896765, width: 335, sourceWidth: 335, targetWidth: 335, y0: 741.5, y1: 846.5, sourceOrder: 0, targetOrder: 0, linkTint: BLUE_LINK },
      { source: 'revenue', target: 'operating_profit', value: 0.21533, width: 36, sourceWidth: 36, targetWidth: 36, y0: 697, y1: 552, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'revenue', target: 'operating_expenses', value: 1.681435, width: 297, sourceWidth: 299, targetWidth: 298, y0: 864.5, y1: 968, sourceOrder: 1, targetOrder: 0, linkTint: RED_LINK },
      { source: 'operating_profit', target: 'net_profit', value: 0.070922, width: 11, sourceWidth: 11, targetWidth: 13, y0: 539.5, y1: 418.5, sourceOrder: 0, targetOrder: 1, linkTint: GREEN_LINK },
      { source: 'operating_profit', target: 'interest', value: 0.144408, width: 23, sourceWidth: 25, targetWidth: 24, y0: 557.5, y1: 707, sourceOrder: 1, targetOrder: 0, linkTint: RED_LINK },
      { source: 'tax_benefit', target: 'net_profit', value: 0.032625, width: 3.5, sourceWidth: 4, targetWidth: 3, y0: 378, y1: 410.5, sourceOrder: 0, targetOrder: 0, linkTint: GREEN_LINK },
      { source: 'other', target: 'net_profit', value: 0.113977, width: 21, sourceWidth: 21, targetWidth: 24, y0: 512.5, y1: 437, sourceOrder: 0, targetOrder: 2, linkTint: GREEN_LINK },
      { source: 'operating_expenses', target: 'sga', value: 1.091918, width: 193, sourceWidth: 193, targetWidth: 193, y0: 915.5, y1: 904.5, sourceOrder: 0, targetOrder: 0, linkTint: RED_LINK },
      { source: 'operating_expenses', target: 'cost_of_service', value: 0.557343, width: 97.5, sourceWidth: 101, targetWidth: 98, y0: 1062.5, y1: 1171, sourceOrder: 1, targetOrder: 0, linkTint: RED_LINK },
      { source: 'operating_expenses', target: 'other_operating_expense', value: 0.032174, width: 4, sourceWidth: 4, targetWidth: 4, y0: 1115, y1: 1343, sourceOrder: 2, targetOrder: 0, linkTint: RED_LINK },
    ],
    i18n: {
      zh: {
