  ...
  i18n: {
    zh: {
      ...
      nodes: {
        ...
        professional_visualization: { label: '专业可视化', notes: ['环比 +5%'] },
        automotive: { label: '汽车', notes: ['环比 +27%'] },
        oem_other: { label: 'OEM 及其他', notes: ['环比 +30%'] },
        revenue: { label: '收入', notes: ['环比 +12%'] },
        gross_profit: { label: '毛利润', notes: ['利润率 73%', '环比 (2 个百分点)'] },
        cost_of_revenue: { label: '收入成本' },
        other: { label: '其他' },
        operating_profit: { label: '营业利润', notes: ['利润率 61%', '环比 (1 个百分点)'] },
        operating_expenses: { label: '运营费用' },
        net_profit: { label: '净利润', notes: ['利润率 56%', '环比 +1 个百分点'] },
        tax: { label: '税费' },
